...
@section('title', __('Cryptowallet - Withdraw Method'))
        ...
        <div class="nk-block card card-bordered nk-block-mh">
            <div class="card-inner">
                <div class="justify-between">
                    <h5 class="title">{{ __('CryptoWallet - Withdraw') }} <span class="meta ml-1"><span class="badge badge-pill badge-xs badge-light">{{ __('Core') }}</span></span></h5>
                ...
                <p>{{ __('Get CryptoWallet details from user for withdrawal funds.') }}</p>
