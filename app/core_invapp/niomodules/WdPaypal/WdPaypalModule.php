...
class WdPaypalModule implements Withdrawable
{
    ...
    {
        return data_get($this->withdrawMethod->config, 'meta.title', $this->withdrawMethod->name);
    }
    ...
    {
        return view("WdPaypal::details", compact('transaction', 'wdm'));
    }
}
