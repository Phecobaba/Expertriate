...
class UserAccountController extends Controller
{
    ...
    private function validateInput(Request $request)
    {
        return $request->validate([
            'wdm-label' => 'required|string',
            'wdm-email' => 'required|string',
            'wdm-currency' => 'nullable'
        ], [
            'wdm-email.*' => __('Enter a valid wallet address.')
        ]);
    }
    ...
    public function save(Request $request)
    {
        ...
        return response()->json(["msg" => __('Your CryptoWallet account successfully added.'), "msg_title" => __('Account Added')]);
    }
    ...
    public function update($hash, Request $request)
    {
        ...
        return response()->json(["reload" => 1500, "msg" => __('The CryptoWallet account successfully updated.'), "msg_title" => __('Account Updated')]);
    }
