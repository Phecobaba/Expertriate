...
class ProfileController extends Controller
{
    ...
    public function View()
    {
        ...
        return view('user.account.profile', compact('metas'));
    }
    ...
    public function welcome()
    {
        ...
        return $user->has_basic ? redirect()->route('dashboard') : view('user.profile-welcome', compact('user'));
    }
    ...
    {        
        ...
        $metaData = $request->only([ 'profile_phone', 'profile_display_name', 'profile_display_full_name', 'profile_dob','profile_country' ]);
