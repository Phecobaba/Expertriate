...
class ApplicationSettingsController extends Controller
{
    ...
    public function userpanel()
    {
        ...
        return view('admin.settings.userpanel', compact('pages', 'schemes'));
    }
    ...
    public function saveSettings(Request $request)
    {
        ...
        $settings   = $this->validateSettings($request); $reload = false;
    ...
    public function storeBranding(Request $request)
    {
        ...
        $request->validate($files, [
            ...
            'logo_dark.mimes' => __('Sorry, invalid file extension in website light logo. You can upload jpeg, png or svg image.'),
        ...
        if ($errors) {
            return response()->json(['error' => __("Something went wrong while uploading. Please check your storage folder permission.")]);
        } else {
