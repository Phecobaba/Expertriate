...
@section('title', __(':Name | Investment Plan', ['name' => __(data_get($invest, 'summary_title'))]))
        ...
        <div class="nk-block-head">
            ...
            <div class="nk-block-between-md g-4">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title fw-normal">{{ data_get($invest, 'summary_title') }}</h3>
                    <div class="nk-block-des">
                        <p>{{ the_inv($invest->ivx) }} <span class="badge{{ the_state($invest->status, ['prefix' => 'badge']) }} ml-1">{{ ucfirst($invest->status) }}</span></p>
                    </div>
                </div>
