                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="form-control-wrap">
                                        <input type="text" name="amount" class="form-control" id="invest-amount" min="0.001" data-msg-min="{{ __("More than :amount", ['amount' => '0.001']) }}" value="{{ data_get($scheme, 'amount') }}" required>
                                    </div>
