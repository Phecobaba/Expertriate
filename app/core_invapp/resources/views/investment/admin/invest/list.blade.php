                ...
                <div class="nk-block-head-content">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li class="nk-block-tools">
                            <div class="dropdown">
                                <a class="dropdown-toggle btn btn-primary" data-toggle="dropdown"><em class="icon ni ni-invest"></em> <span class="d-none d-sm-inline">{{ __("Process") }}</span></small></a>
                            ...
                            <div class="nk-tb-item">
                                <div class="nk-tb-col">
                                    <div class="align-center">
                                        ...
                                        <span class="tb-sub ml-2">{{ data_get($plan, 'scheme.name') }} <span class="d-none d-md-inline">- {{ data_get($plan, 'calc_details') }}</span></span>
                                    </div>
                                </div>
