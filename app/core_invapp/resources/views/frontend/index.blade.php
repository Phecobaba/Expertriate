...
<head>
    ...
    <!-- Site Properties -->
    <title>Coinersavail - Home of Trading</title>
    <!-- Critical preload -->
...
<body>
                ...
                <div class="uk-container" data-uk-navbar>
                    <div class="uk-navbar-left uk-width-auto">
                        <div class="uk-navbar-item">
                            <!-- module logo begin -->
                            <a class="uk-logo" href="https://coinersavail.com/">
                                <img class="uk-margin-small-right in-offset-top-10" data-src="img/mylogo.png" alt="wave" width="240 height="23" data-uk-img>
                            </a>
                            <!-- module logo begin -->
                        </div>
                    </div>
                    <div class="uk-navbar-right uk-width-expand uk-flex uk-flex-right">
                        <ul class="uk-navbar-nav uk-visible@m">
                            <li><a href="https://coinersavail.com/">Home</i></a></li>
            ...
            <div class="uk-container">
                <div class="uk-grid">
                    <div class="uk-width-1-1">
                        <div class="uk-card uk-card-secondary uk-card-small uk-card-body uk-border-rounded uk-animation-scale-up">
                            <div class="uk-grid uk-text-small" data-uk-grid>
                                ...
                                <div class="uk-width-expand@m uk-text-center uk-text-right@m">
                                    <a class="uk-margin-right" href="https://coinersavail.com/contact.html"><i class="fas fa-comment-alt uk-margin-small-right"></i>Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <main>
                ...
                <ul class="uk-slideshow-items uk-light">
                    <li>
                        <div class="uk-position-cover">
                            <img src="img/in-lazy.gif" data-src="img/in-slideshow-image-1.jpg" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                        </div>
                        <span></span>
                        <div class="uk-container">
        ...
        <div class="uk-section uk-section-primary uk-section-xsmall">
            <div class="uk-container in-wave-1">
                <div class="uk-grid uk-grid-divider uk-child-width-1-2@s uk-child-width-1-4@m in-margin-top@s in-margin-bottom@s" data-uk-grid>
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle " uk-scrollspy="cls: uk-animation-slide-left; repeat: true">
                            <div class="uk-width-auto">
                                <img src="img/in-lazy.gif" data-src="img/in-wave-icon-1.svg" alt="wave-icon" width="48" height="48" data-uk-img>
                            </div>
                            <div class="uk-width-expand" uk-scrollspy="cls: uk-animation-slide-left; repeat: true">
                    ...
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle" uk-scrollspy="cls: uk-animation-slide-right; repeat: true">
                            <div class="uk-width-auto">
                                <img src="img/in-lazy.gif" data-src="img/in-wave-icon-3.svg" alt="wave-icon" width="48" height="48" data-uk-img>
                            </div>
                            <div class="uk-width-expand" uk-scrollspy="cls: uk-animation-slide-right; repeat: true">
            ...
            <div class="uk-container in-wave-2">
                <div class="uk-grid">
                    <div class="uk-width-3-4@m">
                        <h1 class="uk-margin-remove-bottom" uk-scrollspy="cls: uk-animation-fade; repeat: true">Industry-<span class="in-highlight">leading</span> prices</h1>
                        <p class="uk-text-lead uk-text-muted uk-margin-small-top uk-margin-bottom" uk-scrollspy="cls: uk-animation-fade; repeat: true">Get ultra-competitive spreads and commissions across all asset classes. Receive even better rates as your volume increases.</p>
                    </div>
                </div>
                <div class="uk-grid-medium uk-grid-match" data-uk-grid>
                    <div class="uk-width-1-2@s uk-width-1-4@m">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-background-contain uk-background-bottom-center" style="background-image: url(img/in-wave-card-bg-1.png);" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                    ...
                    <div class="uk-width-1-2@s uk-width-1-4@m">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-background-contain uk-background-bottom-center" style="background-image: url(img/in-wave-card-bg-2.png);" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                            <h5 class="uk-margin-remove">
                    ...
                    <div class="uk-width-1-2@s uk-width-1-4@m">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-background-contain uk-background-bottom-center" style="background-image: url(img/in-wave-card-bg-3.png);" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                            <h5 class="uk-margin-remove">
                    ...
                    <div class="uk-width-1-2@s uk-width-1-4@m">
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-background-contain uk-background-bottom-center" style="background-image: url(img/in-wave-card-bg-4.png);" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                            <h5 class="uk-margin-remove">
        ...
        <div class="uk-section uk-section-muted uk-padding-large in-wave-3 uk-background-contain uk-background-center" style="background-image: url(img/in-wave-background-1.png);" data-uk-parallax="bgy: -200">
            <div class="uk-container" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                <div class="uk-grid-large uk-flex uk-flex-middle" data-uk-grid>
                    <div class="uk-width-1-2@m">
                        ...
                        <p>Our daily technical analysis feed provides key insights on current market trends in forex, cryptocurrencies, commodities and indices. Our in-house experts assess relevant technical FX information to deliver articles, analyst picks and in-depth insights to inform your trading strategy.</p>
            ...
            <div class="uk-container in-wave-4">
                <div class="uk-grid uk-flex uk-flex-center">
                    <div class="uk-width-1-1 uk-text-center">
                        <h1 class="uk-margin-medium-bottom" uk-scrollspy="cls: uk-animation-scale-up; repeat: true"><span class="in-highlight">Choose </span>Your Available Plan</h1>
                    </div>
                    <div class="uk-width-expand@m">
                        <div class="uk-grid-collapsein-wave-pricing" data-uk-grid>
                            <div>
                                <div class="uk-card uk-card-large uk-card-default uk-card-body uk-box-shadow-small uk-card-hover" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                                    <p class="uk-text-small uk-text-uppercase">Investments<span class="uk-label uk-border-pill uk-text-small uk-margin-small-left">200 USD - 1000USD</span></p>
                                    <h2 class="uk-margin-top uk-margin-remove-bottom">Standard Plan</h2>
                                    <hr>
                                    <ul class="uk-list uk-list-bullet">
                                        <li>Investment Period - 21days</li>
                            ...
                            <div>
                                <div class="uk-card uk-card-large uk-card-default uk-card-body uk-box-shadow-small uk-card-hover" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                                    <p class="uk-text-small uk-text-uppercase">Investments<span class="uk-label uk-border-pill uk-text-small uk-margin-small-left">1000 USD - 8000USD</span></p>
                                    <h2 class="uk-margin-top uk-margin-remove-bottom">Premium Plan</h2>
                                    <hr>
                                    <ul class="uk-list uk-list-bullet">
                                        <li>Investment Period - 30days</li>
                            ...
                            <div>
                                <div class="uk-card uk-card-large uk-card-default uk-card-body uk-box-shadow-small uk-card-hover" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                                    <p class="uk-text-small uk-text-uppercase">Investments<span class="uk-label uk-border-pill uk-text-small uk-margin-small-left">8000USD - 15000USd</span></p>
                                    <h2 class="uk-margin-top uk-margin-remove-bottom">Professional Plan</h2>
                                    <hr>
                                    <ul class="uk-list uk-list-bullet">
                                        <li>Investment Period - 30days</li>
                    ...
                    <div class="uk-width-1-1">
                        <div class="uk-grid-medium uk-child-width-1-2@s uk-child-width-1-5@m uk-text-center uk-margin-large-top" data-uk-grid uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                            <div>
        ...
        <div class="uk-section uk-section-default uk-padding-remove-vertical in-wave-5 in-offset-bottom-40">
            <div class="uk-container">
                <div class="uk-grid">
                    <div class="uk-width-1-1 uk-background-contain uk-background-center-right uk-background-image@m" style="background-image: url(img/in-wave-mockup-1.png);" uk-scrollspy="cls: uk-animation-scale-up; repeat: true">
                        <h1 class="uk-margin-remove-bottom" uk-scrollspy="cls: uk-animation-slide-right; repeat: true">Coming <span class="uk-text-primary" uk-scrollspy="cls: uk-animation-slide-right; repeat: true">Soon</span></h1>
                        <p class="uk-text-lead" uk-scrollspy="cls: uk-animation-slide-left; repeat: true">Coinersavail Mobile App</p>
                        <p class="uk-margin-small-bottom">Will be available on multiple platform</p>
                        <a href="#" class="uk-button uk-button-secondary uk-border-rounded in-button-app uk-button-small uk-button-small">
                            <i class="fab fa-google-play fa-2x"></i>
                            <span class="wrapper">Download from<span>Play Store</span></span>
                        </a>
                        <a href="#" class="uk-button uk-button-secondary uk-border-rounded in-button-app uk-button-small uk-margin-small-left in-margin-remove-left@s">
                            <i class="fab fa-apple fa-2x"></i>
                            <span class="wrapper">Download from<span>App Store</span></span>
                        </a>
                        <a href="#" class="uk-button uk-button-small uk-button-secondary uk-border-rounded uk-visible@m in-button-app uk-margin-small-left">
        ...
        <div class="uk-section uk-section-muted uk-padding-large uk-padding-remove-horizontal uk-margin-medium-top">
            <div class="uk-container">
                <div class="uk-grid-medium" data-uk-grid>
                    <div class="uk-width-expand@m">
                        <img class="uk-margin-small-right in-margin-top-30@s" src="img/in-lazy.gif" data-src="img/mylogo-dark.png" alt="wave" width="240" height="23" data-uk-img>
                                ...
                                <div class="uk-grid-small uk-flex uk-child-width-1-4@s uk-flex uk-child-width-1-5@m in-payment-method uk-text-center" data-uk-grid>
                                    <div>
                                        <div class="uk-card uk-card-default uk-card-small uk-card-body">
                                            <img src="img/in-lazy.gif" data-src="img/bitcoin-logo.png" alt="wave-payment" width="59" height="22" data-uk-img>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="uk-card uk-card-default uk-card-small uk-card-body">
                                            <img src="img/in-lazy.gif" data-src="img/ethereum.svg" alt="wave-payment" width="59" height="22" data-uk-img>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="uk-card uk-card-default uk-card-small uk-card-body">
                                            <img src="img/in-lazy.gif" data-src="img/tether.svg" alt="wave-payment" width="59" height="22" data-uk-img>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="uk-card uk-card-default uk-card-small uk-card-body">
                                            <img src="img/in-lazy.gif" data-src="img/bnb.svg" alt="wave-payment" width="59" height="22" data-uk-img>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="uk-container">
                <div class="uk-grid">
                    ...
                    <div class="uk-width-expand@m uk-text-right@m">
                        <p>© 2005-2021 Coinersavail Inc.</p>
                    </div>
                </div>
            </div>
        </div>
