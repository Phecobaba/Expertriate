                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right dropdown-menu-s1">
                            ...
                            <div class="dropdown-body">
                                <div class="nk-notification-item">
                                    <div class="nk-notification-icon"><em class="icon ni ni-info-fill text-primary"></em></div>
                                    <div class="nk-notification-content">
                                        <div class="nk-notification-text">{{ __('Your dashboard theme has been updated.') }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
