                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <select class="form-select" name="theme_mode_admin">
                                                    ...
                                                    <option disabled value="dark"{{ (sys_settings('ui_theme_mode_admin')=='dark') ? ' selected' : '' }}>{{ __("Dark Only") }}</option>
                                                    <option disabled value="both"{{ (sys_settings('ui_theme_mode_admin')=='both') ? ' selected' : '' }}>{{ __("Both Mode") }}</option>
                                                </select>
                                            </div>
                                            <div class="form-note mt-1 fw-bold text-secondary">{{ __("Color Mode") }}</div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <select class="form-select" name="theme_mode">
                                                    ...
                                                    <option disabled value="dark"{{ (sys_settings('ui_theme_mode')=='dark') ? ' selected' : '' }}>{{ __("Dark Only") }}</option>
                                                    <option disabled value="both"{{ (sys_settings('ui_theme_mode')=='both') ? ' selected' : '' }}>{{ __("Both Mode") }}</option>
                                                </select>
                                            </div>
                                            <div class="form-note mt-1 fw-bold text-secondary">{{ __("Color Mode") }}</div>
                                        </div>
