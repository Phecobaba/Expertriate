            ...
            <div class="nk-block-between">
                ...
                <div class="nk-block-head-content">
                    <ul class="nk-block-tools g-3">
                        {{-- <li>
                            <a href="javascript:void(0)" class="btn btn-white btn-dim btn-outline-gray d-none d-sm-inline-flex"><em class="icon ni ni-download-cloud"></em><span>{{ __("Export") }}</span></a>
                            <a href="javascript:void(0)" class="btn btn-icon btn-white btn-dim btn-outline-gray d-inline-flex d-sm-none"><em class="icon ni ni-download-cloud"></em></a>
                        </li> --}}
                        <li>
                                                                    ...
                                                                    <div class="row gx-6 gy-3">
                                                                        <div class="col-6">
                                                                            <div class="custom-control custom-control-sm custom-checkbox">
                                                                                ...
                                                                                <label class="custom-control-label" for="hasBalance"> {{ __('Have Balance') }}</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <div class="custom-control custom-control-sm custom-checkbox">
                                                                                <input type="checkbox" class="custom-control-input" id="hasKYC">
                                                                                <label class="custom-control-label" for="hasKYC"> {{ __('KYC Verified') }}</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6">
                                ...
                                <div class="nk-tb-item">
                                    ...
                                    <div class="nk-tb-col tb-col-sm">
                                        <ul class="list-status">
                                            <li><em class="icon ni {{ data_get($user, 'is_verified') ? 'text-success ni-check-circle' : 'ni-alert-circle' }} "></em> <span>{{ __('Email') }}</span></li>
                                        </ul>
                                    </div>
